...
module.exports = {
  ...
  recaptcha: { secretKey: '6Lc8P64bAAAAADgPn0L7fkcuiqcF0sYMezYbkFG_' },
  mailer: {
    from: process.env.MAILER_FROM || 'PredictSense Support Team <your_email>',
    options: {
      ...
      auth: {
        user: process.env.MAILER_EMAIL_ID || 'your_email',
